...
<body>
    <div class="card">
        ...
        <h1>{{ $title ?? 'Link not found' }}</h1>
        <p>{{ $body ?? 'This link is no longer available. The content may have been deleted or the link revoked. Please ask the sender for a new link.' }}</p>
    </div>
</body>
</html>
