...
<body>
    ...
    <div class="wrap">
        ...
        <h1>{{ __('errors.500_headline') }}</h1>
        <p class="sub">{{ __('errors.500_text') }}</p>

        <div class="review">
            <div class="who">
                <span class="ava">SV</span>
                <div>
                    <div class="name">{{ __('errors.500_reviewer') }}</div>
                    <div class="stars">★★☆☆☆</div>
                </div>
            </div>
        ...
        <div class="actions">
            <a class="btn btn-primary" href="javascript:location.reload()">{{ __('errors.500_retry') }}</a>
            <a class="btn btn-ghost" href="{{ url('/') }}">{{ __('errors.500_home') }}</a>
        </div>
    </div>
</body>
</html>
