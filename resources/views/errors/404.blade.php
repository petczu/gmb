...
<body>
    ...
    <div class="wrap">
        ...
        <h1>{{ __('errors.404_headline') }}</h1>
        <p class="sub">{{ __('errors.404_text') }}</p>

        <div class="review">
            <div class="who">
                <span class="ava">TI</span>
                <div>
                    <div class="name">{{ __('errors.404_reviewer') }}</div>
                    <div class="stars">★☆☆☆☆</div>
                </div>
            </div>
            <div class="text">{{ __('errors.404_review') }}</div>
            <div class="reply">
        ...
        <div class="actions">
            <a class="btn btn-primary" href="{{ url('/') }}">{{ __('errors.404_home') }}</a>
            <a class="btn btn-ghost" href="javascript:history.back()">{{ __('errors.404_back') }}</a>
        </div>
    </div>
</body>
</html>
