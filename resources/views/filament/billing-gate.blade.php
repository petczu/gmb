@php
    ...
    // First-run onboarding is handled by a redirect to the full-screen
    // /onboarding wizard (MarkOnboardingComplete middleware) — no overlay here.
    // The paywall stays out of the way until onboarding is complete, because
    // the wizard owns the plan step.
...
@elseif (! $onboarding && in_array($state, ['needs_plan', 'payment_problem'], true) && ! $onBilling)
