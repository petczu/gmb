                        ...
                        <div class="pc-pop" x-show="open" x-cloak @click.outside="open = false">
                            ...
                            @forelse ($calendars as $calendar)
                                <div class="row">
                                    ...
                                    <button type="button" class="pc-iconbtn" wire:click="deleteCalendar({{ $calendar->id }})" wire:confirm="{{ __('pages/posts.calendar_delete_confirm') }}" title="{{ __('pages/posts.calendar_delete') }}">
                            ...
                            @foreach ($day['notes'] as $note)
                                ...
                                <div class="pc-note" style="background:{{ $noteBg }};" wire:key="note-{{ $note->id }}" x-data="{ pal: false }">
                                    ...
                                    <div class="pc-note-foot">
                                        ...
                                        <button type="button" class="del" style="color:{{ $noteAccent }};" wire:click="deleteNote({{ $note->id }})"
                                            wire:confirm="{{ __('pages/posts.note_delete_confirm') }}" title="{{ __('pages/posts.note_delete') }}">
