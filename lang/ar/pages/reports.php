...
return [
    ...
    'ai_fallback_title' => 'تم إنشاء التقرير بدون تحليل الذكاء الاصطناعي',
    'ai_fallback_body' => 'استُنفدت حصة تقارير الذكاء الاصطناعي الشهرية، لذا لا يحتوي هذا التقرير على كتل الذكاء الاصطناعي (الملخص، الموظفون، المواضيع). أعد شحن الرصيد أو قم بترقية الخطة لاستعادتها.',
