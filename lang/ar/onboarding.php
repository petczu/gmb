...
return [
    ...
    'could_not_load_body' => 'تعذر تحميل مواقع Google Business الخاصة بك. عادةً ما يكون هذا مؤقتًا: أعد الاتصال وحاول مرة أخرى.',
    'connect_failed_body' => 'تعذر ربط الموقع. لم يتغير شيء: انقر على «ربط» مرة أخرى لإعادة المحاولة.',
];
