...
return [
    ...
    'wiz_trial_note' => 'Your 14-day free trial starts as soon as you continue. No card needed.',
    'wiz_go_checkout' => 'Continue to checkout',
    'wiz_plan_required' => 'Pick a plan and complete checkout to continue.',
    ...
    'wiz_skip_location' => 'Skip for now',
    'skipped_title' => 'You are all set',
    'skipped_body' => 'You can connect your Google Business Profile anytime from the Locations page.',
    ...
    'pending_expired_title' => 'Google session expired',
    'pending_expired' => 'The Google authorization is only valid for a short time and this one has expired. Reconnect and pick your locations again, it only takes a moment.',
    'reconnect_google' => 'Reconnect Google',
    'back' => 'Back',
