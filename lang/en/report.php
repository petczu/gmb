...
return [
    ...
    'perf_title' => 'Google profile performance',
    'perf_views' => 'Profile views',
    'perf_views_sub' => 'Search + Maps',
    'perf_calls' => 'Calls',
    'perf_calls_sub' => 'Phone taps',
    'perf_bookings' => 'Bookings',
    'perf_bookings_sub' => 'Booking button',
    'perf_directions' => 'Directions',
    'perf_directions_sub' => 'Route requests',
    'perf_website_clicks' => 'Website clicks',
    'perf_website_clicks_sub' => 'From the profile',
    'perf_breakdown' => 'Views breakdown',
    ...
    'perf_searches' => 'Top search queries (last 3 months)',
    'perf_note' => 'Source: Google Business Profile. Google delivers this data with a delay of a few days, so the last days of the period may be incomplete.',
