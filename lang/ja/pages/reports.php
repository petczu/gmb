...
return [
    ...
    'ai_fallback_title' => 'AI 分析なしでレポートを生成しました',
    'ai_fallback_body' => '今月の AI レポート枠を使い切ったため、このレポートには AI ブロック(サマリー、スタッフ、トピック、テーマ)が含まれていません。クレジットを追加するかプランをアップグレードすると復活します。',
