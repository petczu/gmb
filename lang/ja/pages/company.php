...
return [
    ...
    'ai_image_section' => 'AI 画像',
    'ai_image_desc' => '生成される投稿画像の見た目の設定。実際のデザインを参照としてアップロードすると、AI がそのスタイルを再現します。',
    'ai_image_refs' => '参照デザイン',
    'ai_image_refs_helper' => 'デザイナー制作の投稿画像を最大 3 枚。構図・タイポグラフィ・配色がすべての生成の指針になります。',
    'ai_image_notes' => 'スタイルメモ',
    'ai_image_notes_ph' => '例: 濃紺のシネマティックなシーン、オレンジのアクセント、太いコンデンス体の大文字見出し',
    'ai_image_style' => '基本スタイル',
    'ai_image_style_photo' => 'フォトリアル',
    'ai_image_style_reference' => '参照に合わせる',
    'ai_image_style_illustration' => 'イラスト',
    'ai_image_style_minimal' => 'ミニマル・タイポグラフィ',
    'ai_image_headline' => '画像内の見出し',
    'ai_image_headline_words' => '見出しの最大語数',
];
